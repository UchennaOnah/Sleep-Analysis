...
st.title('Sleep and Academic Performance Prediction')
st.write(''' This application predicts cumulative GPA based on sleep patterns and related features. 
Choose the model you want to use for predictions. 
''')

# Sidebar for selecting the model
model_choice = st.sidebar.selectbox(
    'Select a model', ('Linear Regression', 'Random Forest')
)
...
frac_nights_with_data = st.number_input('Fraction of Nights With Data', min_value=0.0, max_value=1.0, step=0.1)
term_gpa = st.number_input('Term Grade Point Average', min_value=0.0, max_value=10.0, step=0.1)
